...
<div id="barravoltar2">
<a href="exibir_admin.php"><div class="home"></div></a>
</div>
...
$cpf = $_GET['txtcodigo'];	
$resposta= mysql_query("SELECT * FROM admin WHERE cpf='$cpf'");
...
<form method='post' action='alterar_admin.php'>

<table width="500">
  <tr><th colspan="2"><div id="title" align="center">Alterar Admin</div></th></tr>
